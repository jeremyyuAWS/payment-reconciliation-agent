  ...
  useEffect(() => {
    ...
    setSteps([
      ...
      },
      {
        ...
        content: 'The AI Financial Assistant can answer questions about your reconciliation data in natural language. Try asking "Show me unreconciled payments" or "Why wasn\'t invoice #1003 reconciled?"',
        placement: 'top',
      },
      {
